...
public void button (int id_ev , int id_cl)
{
    ...
    private void setStage(String l, String date) {
        try {
            ...
            veil.setStyle("-fx-background-color:rgba(21,21,21,0.7)");
...
//                   
 ...
 int iddd = us.get(i).getId_pc();
                    ...
                    fbt.addEventHandler(ActionEvent.ACTION, new EventHandler<ActionEvent>() {
                        @Override
                        public void handle(ActionEvent actionEvent) { 
                            System.out.println ("l'id est " + iddd ); 
                            SV.modifierpostch(iddd,ch.getId(),SV.nmr_rea(iddd) );
        ...
        JFXTextField comment = new JFXTextField();
        JFXButton batna = new JFXButton("ajouter photo");
        JFXButton batna2 = new JFXButton("Poster");
        bt.getStyleClass().add("parti");
                    bt2.getStyleClass().add("det");
        com= new HBox();     
        imgl = new Label();
