 ...
 * @author medam
 */
public class AVClientAppointementController implements Initializable {
    ...
    private JFXButton UpdateButton;
        ...
        Connection con1=ConnexionBD.getinstance().getcnx();
    ...
    private void ajouterButton(ActionEvent event) {
       ...
       int result = r.nextInt(1000-1)+1;
        ...
        String idappoint = Integer.toString(result);
         
        String query = "insert into appointement values(?, ?, ?, ?)";
    
           try {
               
                PreparedStatement pre = (PreparedStatement) con1.prepareStatement(query);
                pre.setString(1, idappoint);
