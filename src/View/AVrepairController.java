 ...
 * @author medam
 */
public class AVrepairController implements Initializable {
   ...
   private  Connection con5=ConnexionBD.getinstance().getcnx();
    ...
    /*    
        ...
        */
        ...
        try {
            PreparedStatement ps = (PreparedStatement) con5.prepareStatement(sql);
